package com.example.vita.happycooking;
...
public class detailresep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_detailresep);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        txtid_berita = (TextView) findViewById(id_resep);
        txtjudul = (TextView) findViewById(id.judul);
        txtisi = (TextView) findViewById(id.isi);
        imggambar = (ImageView) findViewById(id.gambar);

        detail = (ScrollView) findViewById(id.detail);
